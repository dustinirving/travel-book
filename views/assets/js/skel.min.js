  ...
  let t = {
    ...
    changeState: function (e) {
      t.iterate(t.obj.breakpoints, function (e) {
        ...
        (t.lets.stateId = t.stateId),
        (t.lets.state = t.state),
        t.trigger('change'),
        t.iterate(t.obj.breakpoints, function (e) {
          ...
          ? (t.matchesMedia = function (t) {
              ...
              ;(e.type = 'text/css'),
                ...
                (i =
                  ...
                  e.currentStyle)
              let a = '@media ' + t + '{ #matchmediajs-test { width: 1px; } }'
              return (
    ...
    initlets: function () {
      ...
      ;(e = 'other'),
        ...
        (t.lets.osVersion = n),
        (t.lets.IEVersion =
          'ie' == t.lets.browser ? t.lets.browserVersion : 99),
        (t.lets.touch =
          'wp' == t.lets.os
